!(function (e, t) {
    ...
    if (
      ...
      for (u = (s = ke.map(T(o, "script"), N)).length; f < p; f++)
        (c = o),
          ...
          r.call(e[f], c, f);
      if (u)
        for (l = s[s.length - 1].ownerDocument, ke.map(s, q), f = 0; f < u; f++)
          (c = s[f]),
            lt.test(c.type || "") &&
  ...
  !(function () {
      ...
      var n = t.length > 0,
        ...
        o = function (i, o, a, s, u) {
          ...
          for (
            ...
            if (r && c) {
              for (
                l = 0, o || c.ownerDocument == N || (p(c), (a = !L));
                (f = e[l++]);
    ...
    function k(e, t, n, r) {
      ...
      return (
        (c || C(e, l))(r, t, !L, n, !t || (ie.test(e) && f(t.parentNode)) || t),
        n
      );
    }
    var S,
    ...
    try {
      M.apply((ae = ue.call(qe.childNodes)), qe.childNodes),
  ...
  (ke.filter = function (e, t, n) {
    ...
    ke.fn.extend({
      ...
      is: function (e) {
        return !!s(
          this,
          "string" == typeof e && Me.test(e) ? ke(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || Pe), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          Re.test(r[1]) && ke.isPlainObject(t))
        )
      ...
      function (e, t) {
        ke.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              ($e[e] || ke.uniqueSort(i), Ie.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
    ...
    ke.extend({
      ...
      ready: function (e) {
        (!0 === e ? --ke.readyWait : ke.isReady) ||
          ((ke.isReady = !0),
          (!0 !== e && --ke.readyWait > 0) || _e.resolveWith(be, [ke]));
      },
    }),
    (ke.ready.then = _e.then),
      ...
      _default: {
        ...
        set: function (e) {
          ke.fx.step[e.prop]
            ? ke.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!ke.cssHooks[e.prop] && null == e.elem.style[I(e.prop)])
            ? (e.elem[e.prop] = e.now)
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (i in a) a[i] && a[i].stop && qt.test(i) && r(a[i]);
            for (i = o.length; i--; )
              o[i].elem !== this ||
                (null != e && o[i].queue !== e) ||
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && ke.isXMLDoc(e)) ||
                (i =
                  ...
                  (ke.expr.match.bool.test(t) ? Lt : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Ot.test(e.nodeName) || (Mt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
  ...
  ke.ajaxSetup({
    ...
    ke.each(["top", "left"], function (e, t) {
      ke.cssHooks[t] = P(ye.pixelPosition, function (e, n) {
        if (n)
          return (n = R(e, t)), yt.test(n) ? ke(e).position()[t] + "px" : n;
      });
    }),
