...
(function () {
  var data = {
    ...
    blob: {
      ...
      55: ["GTM-W8KL5Q5"],
      6: "117991082",
      8: "res_ts:1724372280243712,srv_cl:807569378,ds:live,cv:9",
      9: "GTM-W8KL5Q5",
    },
    permissions: {
      __c: {},
...
*/
      ...
      for (var h = g.createZone(a, c), m = 0; m < b.length; m++) {
        ...
        if (g.registerChild(n, Hi(5), h)) {
          var p = n,
            ...
            t = f;
          if (Lb(p, "GTM-"))
            Dz(p, void 0, !1, { source: 1, fromContainerExecution: !0 });
          else {
            var v = $A("js", Fb());
            Dz(p, void 0, !0, { source: 1, fromContainerExecution: !0 });
            var w = { originatingEntity: u, inheritParentConfig: t };
            dB(v, q, w);
            dB(aB(p, r), q, w);
          }
        }
  ...
  k.isActive = function (a, b) {
    ...
    for (var e = 0; e < c.sg.length; e++) if (this.H[c.sg[e]].Ee(b)) return !0;
    return !1;
  };
  ...
  k.registerChild = function (a, b, c) {
    var d = this.C[a];
    if ((!d && Tn[a]) || (!d && Rj(a)) || (d && d.Bj !== b)) return !1;
  ...
  tE.prototype.R = function (a, b) {
    ...
    a <= c.eventId || (c.Ee !== b && this.C.push({ eventId: a, Ee: b }));
  };
  tE.prototype.Ee = function (a) {
    for (var b = this.C.length - 1; b >= 0; b--)
      if (this.C[b].eventId <= a) return this.C[b].Ee;
    return !1;
  };
  tE.prototype.M = function (a, b) {
    b = b || [];
    if (!this.H || sE[a] || this.H[a]) return !0;
  ...
  function yE(a, b) {
    ...
    var p = { source: m, fromContainerExecution: !0 },
      q = function (r) {
        uA(
          ...
          function (u) {
            for (
              var t = vA().getExternalRestrictions(0, Ij()),
                v = l(t),
                w = v.next();
              !w.done;
              w = v.next()
        ...
        wA(
          ...
          function (u) {
            for (
              var t = vA().getExternalRestrictions(1, Ij()),
                v = l(t),
                w = v.next();
              !w.done;
              w = v.next()
    ...
    g ? Gz(a, e, p, q) : Dz(a, e, !Lb(a, "GTM-"), p, q);
    f &&
      n.Jb() === "__zone" &&
      qE(Number.MIN_SAFE_INTEGER, [a], null, {}, lE(wD(this)));
    return a;
  }
      ...
      function b(f, g, h) {
        var m = {},
          ...
          p = function (t, v, w) {
            ...
            if (t) {
              m.items = m.items || [];
              for (var y = {}, A = 0; A < t.length; y = { mg: void 0 }, A++)
                (y.mg = {}),
                  zb(
                    t[A],
                    (function (E) {
      ...
      (function (f) {
        ...
        if (sb(g) && g.indexOf("G-") === 0) {
          ...
          f.vtp_sendEcommerceData &&
            (Hm.hasOwnProperty(h) || h === "checkout_option") &&
            b(f, h, m);
          var n = f.vtp_eventSettingsVariable;
          if (n) for (var p in n) n.hasOwnProperty(p) && (m[p] = n[p]);
          if (f.vtp_eventSettingsTable) {
            var q = NQ(f.vtp_eventSettingsTable, "parameter", "parameterValue"),
              r;
            for (r in q) m[r] = q[r];
          }
          var u = NQ(f.vtp_eventParameters, "name", "value"),
            t;
          for (t in u) u.hasOwnProperty(t) && (m[t] = u[t]);
          var v = f.vtp_userDataVariable;
          v && (m[N.m.yb] = v);
          if (m.hasOwnProperty(N.m.Vb) || f.vtp_userProperties) {
            var w = m[N.m.Vb] || {};
            KQ(NQ(f.vtp_userProperties, "name", "value"), w);
            m[N.m.Vb] = w;
          }
          var y = {
              originatingEntity: Kz(
                1,
